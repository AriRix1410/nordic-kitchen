...
- __The Footer__ 
  ...
  - For larger screen sizes the footer is fixed to allow users the ability to access the links without having to scroll.

![Footer](/assets/images/footer.png)

- __Recipes__

  - This page will allow users to select which type of recipe they are looking for, Drinks, Savoury or Sweet.
  - The images on this page are clickable and open page for the 3 recipe categories.
  - When in desktop view, the images on this page have a hover feature that displays a faded effect  with the names of the recipe catergories over it. On smaller screens this is removed and the category names are always visible.  
